# Aris Program Design System

The foundational design system for the Aris umbrella organization. This system establishes core visual identity, shared principles, and reusable components that individual products (Scroll Press, RSM Studio) can inherit and customize for their specific needs.
...
This design system builds on top of **ARCH 1.0** (Accessible Research Charter for Hypertext), defined in `/program/strategy/arch-1.0.md`. ARCH defines the structural and behavioral floor for manuscript output: responsive layout (320px-2560px), WCAG 2.1 AA contrast, dark mode via prefers-color-scheme, prefers-reduced-motion support, and print stylesheets. This design system (and BRAIID) provides the aesthetic layer above that floor. Any design decision that conflicts with ARCH is wrong.
...
**Humane**: Beautiful, effortless experiences that respect your time, humanity, and focus.
...
```css
--font-serif: 'Crimson Pro', 'Georgia', 'Garamond', 'Times New Roman', serif;
...
- **Studio buttons**: Hover to blue (#38B4F8)
...
All CSS custom properties are redefined for dark mode while maintaining the same semantic meaning and contrast relationships.
...
- **Primary brand color**: Products use their assigned colors (#FF6B6B for Press, #38B4F8 for Studio)
...
- **RSM Studio**: Blue accent (#38B4F8), editor-focused components, collaboration interface patterns
